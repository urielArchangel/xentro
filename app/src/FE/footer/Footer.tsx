...
import logo from "@/app/images/xentroLogoWName.png";
...
const Footer = () => {
  return (
    <footer className="text-[#ffffff8d] w-[90%] mx-auto">
      <div
        className={
          footercss.bg_gradient_border +
          " border-0 p-[0.07em] rounded-[18px] hd-shadow"
        }
      >
        <section
          className={
            footercss.innterContainerBG +
            " relative py-28  flex justify-around w-full h-full rounded-[18px] "
          }
        >
          ...
          <div className="self-center">
            <h6 className="max-w-[300px] text-[20px] font-semibold ">
